...
public class Flight_SeatingGUI5 {
    public Flight_SeatingGUI5(String flightNum, String email) throws Exception{
        try {
            UIManager.setLookAndFeel(UIManager.getCrossPlatformLookAndFeelClassName());
        } catch (Exception e) {}
        JFrame flightseatingGUIframe = new Flight_SeatingGUI5Frame(flightNum,email);
        flightseatingGUIframe.setVisible(true);
    }
}

class Flight_SeatingGUI5Frame extends JFrame 
{
    static JToggleButton btn[]=new JToggleButton[50];
    boolean needsDiscount;
    public Flight_SeatingGUI5Frame(final String flightNum, final String email) throws Exception
    {
