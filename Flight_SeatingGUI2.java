...
public class Flight_SeatingGUI2 {
    public Flight_SeatingGUI2(String flightNum, String email) throws Exception{
        try {
            UIManager.setLookAndFeel(UIManager.getCrossPlatformLookAndFeelClassName());
        } catch (Exception e) {}
        JFrame flightseatingGUIframe = new Flight_SeatingGUI2Frame(flightNum,email);
        flightseatingGUIframe.setVisible(true);
    }
}

class Flight_SeatingGUI2Frame extends JFrame 
{
    static JToggleButton btn[]=new JToggleButton[60];
    boolean needsDiscount;
    public Flight_SeatingGUI2Frame(final String flightNum, final String email) throws Exception
    {
