...
public class Flight_SeatingGUI3 {
    public Flight_SeatingGUI3(String flightNum, String email) throws Exception{
        try {
            UIManager.setLookAndFeel(UIManager.getCrossPlatformLookAndFeelClassName());
        } catch (Exception e) {}
        JFrame flightseatingGUIframe = new Flight_SeatingGUI3Frame(flightNum,email);
        flightseatingGUIframe.setVisible(true);
    }
}

class Flight_SeatingGUI3Frame extends JFrame 
{
    static JToggleButton btn[]=new JToggleButton[71];
    boolean needsDiscount;
    public Flight_SeatingGUI3Frame(final String flightNum, final String email) throws Exception
    {
    ...
    p2.add(btn1);
    p2.add(btn2);
    p2.add(Box.createRigidArea(new Dimension(75,0)));
    p2.add(btn3);
    p2.add(btn4);
    p2.add(btn5);
    p2.add(Box.createRigidArea(new Dimension(75,0)));
    ...
    p3.add(btn8);
    p3.add(btn9);
    p3.add(Box.createRigidArea(new Dimension(75,0)));
    p3.add(btn10);
    p3.add(btn11);
    p3.add(btn12);
    p3.add(Box.createRigidArea(new Dimension(75,0)));
    ...
    p4.add(btn15);
    p4.add(btn16);
    p4.add(Box.createRigidArea(new Dimension(75,0)));
    p4.add(btn17);
    p4.add(btn18);
    p4.add(btn19);
    p4.add(Box.createRigidArea(new Dimension(75,0)));
    ...
    p5.add(btn22);
    p5.add(btn23);
    p5.add(Box.createRigidArea(new Dimension(75,0)));
    p5.add(btn24);
    p5.add(btn25);
    p5.add(btn26);
    p5.add(Box.createRigidArea(new Dimension(75,0)));
    ...
    p6.add(btn29);
    p6.add(btn30);
    p6.add(Box.createRigidArea(new Dimension(75,0)));
    p6.add(btn31);
    p6.add(btn32);
    p6.add(btn33);
    p6.add(Box.createRigidArea(new Dimension(75,0)));
    ...
    p7.add(btn36);
    p7.add(btn37);
    p7.add(Box.createRigidArea(new Dimension(75,0)));
    p7.add(btn38);
    p7.add(btn39);
    p7.add(btn40);
    p7.add(Box.createRigidArea(new Dimension(75,0)));
    ...
    p8.add(btn43);
    p8.add(btn44);
    p8.add(Box.createRigidArea(new Dimension(75,0)));
    p8.add(btn45);
    p8.add(btn46);
    p8.add(btn47);
    p8.add(Box.createRigidArea(new Dimension(75,0)));
    ...
    p9.add(btn50);
    p9.add(btn51);
    p9.add(Box.createRigidArea(new Dimension(75,0)));
    p9.add(btn53);
    p9.add(btn54);
    p9.add(btn55);
    p9.add(Box.createRigidArea(new Dimension(75,0)));
    ...
    p10.add(btn58);
    p10.add(btn59);
    p10.add(Box.createRigidArea(new Dimension(75,0)));
    p10.add(btn60);
    p10.add(btn61);
    p10.add(btn62);
    p10.add(Box.createRigidArea(new Dimension(75,0)));
    ...
    p11.add(btn65);
    p11.add(btn66);
    p11.add(Box.createRigidArea(new Dimension(75,0)));
    p11.add(btn67);
    p11.add(btn68);
    p11.add(btn69);
    p11.add(Box.createRigidArea(new Dimension(75,0)));
